...
# correlate to:         https://github.com/YosysHQ/yosys/commit/a0f5ba85
#conda install $CONDA_FLAGS -c litex-hub/label/main yosys="0.9_5636_ga0f5ba85"
conda install $CONDA_FLAGS -c litex-hub/label/main yosys="0.11_48_g113c94384"
...
# correlate to:         https://github.com/SymbiFlow/yosys-symbiflow-plugins/commit/6c4141c8e4f35920f6a6e6d11dcf3cca1bebc37c
conda install $CONDA_FLAGS -c litex-hub/label/main yosys-symbiflow-plugins="1.0.0_7_511_g6c4141c"
